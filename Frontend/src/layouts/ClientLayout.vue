      ...
      <div class="upper-header">
        <nav class="bg-red-500 w-full border-b">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-2 px-4">
            ...
            <form class="max-w-md mx-auto flex-grow px-4" @submit="handleSearch">
                  ...
                  <div class="mx-auto px-0">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-y-8 gap-x-4">
                      ...
                      <div class="flex justify-center items-center"><img
                          ...
                          alt="GIORGIO ARMANI Logo" class="h-16 max-w-full object-contain" /></div>
                      <div class="flex justify-center items-center"><img
                      ...
                      <div class="flex justify-center items-center"><img
                          ...
                          alt="Jean Paul GAULTIER Logo" class="h-16 max-w-full object-contain" /></div>
                      <div class="flex justify-center items-center"><img
                      ...
                      <div class="flex justify-center items-center"><img
                          ...
                          alt="narciso rodriguez Logo" class="h-16 max-w-full object-contain" /></div>
                      <div class="flex justify-center items-center"><img
                          src="https://orchard.vn/wp-content/uploads/2024/06/fragnance-logo-text-parfums-de-marly.webp"
                          alt="PARFUMS DE MARLY Logo" class="h-16 max-w-full object-contain" /></div>
                      <div class="flex justify-center items-center"><img
                      ...
                      <div class="flex justify-center items-center"><img
                          ...
                          alt="Yves Saint Laurent Logo" class="h-16 max-w-full object-contain" /></div>
                    </div>
                  </div>
                </div>
              </div>
