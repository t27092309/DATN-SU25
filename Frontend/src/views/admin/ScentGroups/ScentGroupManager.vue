...
const fetchScentGroups = async () => {
  try {
    const response = await axios.get("http://localhost:8000/api/scent-groups");
...
const addScentGroup = async () => {
  ...
  try {
    const response = await axios.post(
      "http://localhost:8000/api/scent-groups",
      {
...
const confirmDelete = async () => {
  try {
    const response = await axios.delete(`http://localhost:8000/api/scent-groups/${deleteId.value}`);
    await fetchScentGroups();
