...
export default {
  ...
  methods: {
    ...
    async updateCategory() {
      ...
      try {
        const response = await axios.put(`http://localhost:8000/api/categories/${this.$route.params.id}`, {
        ...
        if (errors) {
          ...
          this.message = error.response?.data?.message || 'Có lỗi khi cập nhật danh mục!';
        }
        this.messageClass = 'text-danger';
      }
    },
