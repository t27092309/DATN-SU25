    ...
    <div v-else class="bg-white shadow-lg rounded-lg p-8">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 border-b pb-6">
        <div>
          ...
          <p class="text-gray-700 mb-2">
            <span class="font-medium">Mã đơn hàng:</span> #{{ order.id }}
          </p>
          <p class="text-gray-700 mb-2">
          ...
          <p v-if="order.notes" class="text-gray-700 mb-2">
        ...
        <div>
          ...
          <div v-if="order.order_address">
            <p class="text-gray-700 mb-1">
              ...
              {{ order.order_address.recipient_name }}
            </p>
            <p class="text-gray-700 mb-1">
            ...
            <p class="text-gray-700 mb-1">
              ...
              {{ order.order_address.full_address }}
            </p>
          </div>
          ...
          <div v-if="order.payment_info">
            <p class="text-gray-700 mb-1">
              ...
              <span
                :class="
                  getPaymentStatusClass(order.payment_info.payment_status)
                "
                class="px-3 py-1 rounded-full text-sm font-medium ml-2"
              >
            ...
            <p class="text-gray-700 mb-1">
              <span class="font-medium">Số tiền thanh toán:</span>
              {{ formatCurrency(order.payment_info.amount) }}
            </p>
            <p v-if="order.payment_info.paid_at" class="text-gray-700 mb-1">
              <span class="font-medium">Thời gian thanh toán:</span>
      ...
      <div>
        ...
        <div class="overflow-x-auto">
          <table
            class="min-w-full bg-white border border-gray-200 rounded-lg table-fixed"
          >
            <thead>
              <tr
              ...
              >
                <td colspan="4" class="py-3 px-6">
                  ...
                  >
                    <div class="flex items-center w-1/2">
                      ...
                      <div class="flex flex-col">
                        ...
                        <span class="text-xs text-gray-500 mt-1"
                          >Phân loại: {{ item.variant_name }}</span
                        >
                      </div>
                    </div>
                    ...
                    <div
                      class="flex justify-end items-center w-1/6 font-medium"
                    >
...
const getStatusText = (status) => {
  switch (status) {
    ...
    case "refunded":
      return "Đã hoàn tiền"; // Giữ nguyên text cho trạng thái đã hoàn tiền
    case "rejected":
      return "Từ chối"; // Giữ nguyên text cho trạng thái đã hoàn tiền
    default:
      return "Không rõ";
  }
};
